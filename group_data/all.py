...
openwebui = {
    ...
    "extra_env": {
        ...
        "DEFAULT_MODELS": "router-chat,router-chat-thinking,router-web-research,router-translate-de,router-translate-en,router-fix-grammar-en,router-fix-grammar-de,router-linux-cli",
