...
4. Implement production-ready, self-explanatory code matching repo patterns; never add explanatory code comments — explanations belong in commit messages, not in code. Run relevant tests, lint, format, compiler/static checks, and playwright-cli browser checks when applicable.
