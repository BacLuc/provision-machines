...
# These values can be overridden via --data or group-specific files

# User configuration
user = "vscode"

# Runtime environments - enable flags (all disabled by default)
enable_docker = False
enable_zsh = False
enable_tmux = False
enable_nvm = False
...
# Development tools - enable flags (all disabled by default)
